...
for a in JSON_LIST:
    ...
    print('  Setting activity type to ' + ACTIVITY_TYPE)    
    ACTIVITY_URL = URL_GC_ACTIVITY + str(a['activityId'])
    ACTIVITY_PAGE_URL = URL_GC_ACTIVITY_PAGE + str(a['activityId'])
    ACTIVITY_POST_DATA = {'activityTypeDTO': {'typeId': ACTIVITY_TYPE_ID, 'typeKey': ACTIVITY_TYPE, 'parentTypeId': 17}, 'activityId': a['activityId'] }
